...
namespace str {
  ...
  /** Remove characters after certain characters
   * \param str = the string to be cleaned
   * \param chars = the characters after which the string is truncated
   * \param include = remove also the first delimiter (default true)
   */
  void clean_after(std::string *str, const char *chars, bool include = true);
